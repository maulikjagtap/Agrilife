      ...
      <nav class="navbar navbar-inverse">
          ...
          <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="sidebar-menu">
              <li class="header">Seller Side</li>
              <li class="treeview">
			 ...
			 <li class="treeview">
				...
				<?php
					...
					{
?>
                  <li><a href="<?php echo($row['p_name']); ?>form.php"><i class="fa fa-angle-right"></i><?php echo($row['p_name']); ?>form</a></li>
                  <li><a href="<?php echo($row['p_name']); ?>ofyours.php"><i class="fa fa-angle-right"></i>your Wheat data</a></li>
				  		<?php }?>
                </ul>
              </li>
