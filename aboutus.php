		...
		<!-- Header -->
			<div id="header">
				<div class="container">
					...
					<!-- Logo -->
						<h1><a href="index.php" id="logo">Agri Life</a></h1>
					...
					<div class="row">
						...
						<div id="sidebar" class="4u sidebar">
							<section>
								...
								<div class="row half">
									<section class="6u">
										<ul class="default">
											<li><a href="UrbanGarden.php">UrbanGarden</a></li>
											<li><a href="AgriInfo.php">AgriInfo</a></li>
						...
						<div id="content" class="8u skel-cell-important">
							<section>
								<header class="major">
									<h2>AboutUs</h2>
									<span class="byline">Detail Intro About AgriLife</span>
								</header>
									...
									<div class="row">
										...
										<section class="6u">
											<ul class="default">
												...
												<li><a href="Login.php">Buyer/seller</a></li>
												<li><a href="AgriInfo.php">Agri_info</a></li>
											</ul>
										</section>
									</div>
								</section>
